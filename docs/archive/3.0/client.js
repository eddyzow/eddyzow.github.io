...
function switchDarkTheme() {
  localStorage.setItem("homepage-theme", "dark");
    ...
    for(var i=0;i<links.length;i++)
    {
        links[i].setAttribute("style", "border-left: 2px solid white; border-right: 2px solid white;");
    }
    ...
    document.getElementById("theme-changer").setAttribute("style", "filter: drop-shadow(0px 0px 8px #ffffff);");
    document.getElementById("theme-changer-icon").setAttribute("class", "fa-solid fa-sun");
...
function switchLightTheme() {
  ...
  document.body.setAttribute("style", "background-color:#ffe8cb; color:#535353;");
  var links = document.getElementsByTagName("a");
  for(var i=0;i<links.length;i++)
  {
  ...
  for(var i=0;i<links.length;i++)
  {
      links[i].setAttribute("style", "border-left: 2px solid #3b3b3b; border-right: 2px solid #3b3b3b;");
  }
  ...
  document.getElementById("theme-changer").setAttribute("style", "filter: drop-shadow(0px 0px 8px #3b3b3b);");

  document.getElementById("theme-changer-icon").setAttribute("class", "fa-solid fa-moon");
